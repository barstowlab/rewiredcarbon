...
scenarioTableFileName = 'input/Scenario Tables/sfig-EETscaleup-B.csv'

outputFileDirname = 'output/sfig-EETscaleup-B'
outputFilename = outputFileDirname + '/' + 'sfig-EETscaleup-B.csv'
...
targetEfficiencyRatios = [0.5, 0.75]
collectedOutputDict = {}
